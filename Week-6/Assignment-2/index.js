const { generateMatrix, displayMatrix, validateInput } = require("./utils");
...
function spirallyTraverse(matrix) {
    if (!validateInput(matrix)) throw new Error('Invalid input provided');
...
try {
    ...
    /**
     * [1, 2, 3, 4, 5, 6, 7, 8, 9, 18, 27, 36, 45, 54, 63, 72, 81, 80, 79, 78, 77, 76, 75, 74, 
     * 73, 64, 55, 46, 37, 28, 19, 10, 11, 12, 13, 14, 15, 16, 17, 26, 35, 44, 53, 62, 71, 70, 
